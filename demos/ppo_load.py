...
单独启动训练:
python ./demos/ppo_load.py --model-path /data/user/wutianyang/Coding/KataRL2/logs/debug/ppo/simba_continuous_mlp/Hopper-v4__gymnasium/seed_42_42/20250828-182321/ckpts/sac-40.pkl
"""
import sys
