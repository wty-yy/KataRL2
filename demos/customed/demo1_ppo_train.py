"""
python ./demos/customed/demo1_ppo_train.py --help
"""
import sys
...
from katarl2.agents import PPO, PPOContinuousConfig
...
@dataclass
class CustomPPOConfig(PPOContinuousConfig):
