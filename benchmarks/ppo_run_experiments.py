...
# 配置任务
ppo_type: Literal['basic', 'simba'] = 'simba'
tasks = [
    ...
    # # DMC Easy
    # ("agent:cont", "env:dmc", "walker-walk",         [0, 0, 0], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "walker-run",          [1, 1, 1], [0, 1, 2]),
    # # DMC HARD
    # ("agent:cont", "env:dmc", "humanoid-walk",       [2, 2, 2], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "dog-walk",            [3 ,3, 3], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "humanoid-run",        [4, 4, 4], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "dog-run",             [5, 5, 5], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "dog-trot",            [6, 6, 6], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "humanoid-stand",      [7, 7, 7], [0, 1, 2]),
    # ("agent:cont", "env:dmc", "dog-stand",           [4, 4, 4], [0, 1, 2]),
]
